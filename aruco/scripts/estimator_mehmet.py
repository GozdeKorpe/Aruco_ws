...
marker_positions = [id_01, id_06, id_11, id_16, id_21, id_26, id_31, id_36, id_41, id_46, id_51, id_56, id_61, id_66,
                    id_71, id_76, id_81, id_86, id_91, id_96, id_103, id_108, id_113, id_118, id_123, id_128, id_133, id_138]
str_marker_positions = ["id_01", "id_06", "id_11", "id_16", "id_21", "id_26", "id_31", "id_36", "id_41", "id_46", "id_51", "id_56", "id_61", "id_66", "id_71", "id_76", "id_81", "id_86", "id_91", "id_96", "id_103", "id_108", "id_113", "id_118", "id_123", "id_128", "id_133", "id_138"]
...
def publish_message():
    pub_x = rospy.Publisher('/positionx', Float32, queue_size=1)
    pub_y = rospy.Publisher('/positiony', Float32, queue_size=1)
    pub_yaw = rospy.Publisher('/yaw', Float32, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        if ids is not None:
            ...
            try:
                ...
                logger.info(message)
                data_x = float(absolute_x_position)
                data_y = float(absolute_y_position)
                data_yaw = float(yaw_camera)

                # you could simultaneously display the data
                # on the terminal and to the log file
                rospy.loginfo(data_x)
                rospy.loginfo(data_y)
                rospy.loginfo(data_yaw)

                # publish the data to the topic using publish()
                pub_x.publish(data_x)
                pub_y.publish(data_y)
                pub_yaw.publish(data_yaw)
                rate.sleep()
            except:
                pass
