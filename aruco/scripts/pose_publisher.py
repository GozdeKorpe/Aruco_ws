...
# -- Font for the text in the image
    ...
    while not rospy.is_shutdown():
        ...
        if ids is not None and ids[0] == id_to_find:
            ...
            cv2.putText(frame, str_position, (0, 100), font,
            ...
            cv2.putText(frame, str_attitude, (0, 150), font,
                        1, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(frame, str_position, (0, 200), font,
                        1, (0, 255, 0), 2, cv2.LINE_AA)
            ...
            cv2.putText(frame, str_attitude, (0, 250), font,
                        1, (0, 255, 0), 2, cv2.LINE_AA)
